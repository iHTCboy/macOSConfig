...
![Xcode13-Alternatelcons-0](https://ihtcboy.com/images/2021-Xcode13-Alternatelcons-0.png)
...
![Xcode13-Alternatelcons-1](https://ihtcboy.com/images/2021-Xcode13-Alternatelcons-1.jpg)

跟添加 App 图标一样，把所有需要的图标集都添加到 `Assets.xcassets` 中就可以。

然后将 `Include all app icon assets` 改为 `YES`。（注意，需要 Xcode 13 以上才有这个字段！）

![Xcode13-Alternatelcons-2](https://ihtcboy.com/images/2021-Xcode13-Alternatelcons-2.jpg)
...
![Xcode13-Alternatelcons-3](https://ihtcboy.com/images/2021-Xcode13-Alternatelcons-3.jpg)
...
![Xcode13-Alternatelcons-4](https://ihtcboy.com/images/2021-Xcode13-Alternatelcons-4.jpg)
...
![Xcode13-Alternatelcons-5](https://ihtcboy.com/images/2021-Xcode13-Alternatelcons-5.jpg)
 
如上图所示，使用有透明区域的图片，最终显示的图标，背景将会变成黑色：

![Xcode13-Alternatelcons-6](https://ihtcboy.com/images/2021-Xcode13-Alternatelcons-6.jpg)


##### 1024 图标不要用 JPG 格式

1024x1024 的商店图片，作为主图标时可以用jpg。如果用 png 格式，则不能有透明区域，否则上传 ipa 包体时会报错，无法上报。
![Xcode13-Alternatelcons-7](https://ihtcboy.com/images/2021-Xcode13-Alternatelcons-7.jpg)
...
![Xcode13-Alternatelcons-8](https://ihtcboy.com/images/2021-Xcode13-Alternatelcons-8.jpg)
...
![Xcode13-Alternatelcons-9](https://ihtcboy.com/images/2021-Xcode13-Alternatelcons-9.jpg)
...
![Xcode13-Alternatelcons-10](https://ihtcboy.com/images/2021-Xcode13-Alternatelcons-10.png)
