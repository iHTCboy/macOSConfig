...
2. `虎书`：《现代编译原理 — C语言描 》（Modern Compiler Implement in C）
3. `鲸书`：《高级编译器设计与实现》（Advanced Compiler Design and Implementation）

龙书：《编译原理》是编译领域无可替代的经典著作，被广大计算机专业人士誉为“龙书”。
...
2020年，手机只是小小一部分，智慧家居大屏、穿戴、车机、音响、手表、PC等等各种各样设备，作为开发者，我们不要只关注自己开发的App，应该去理解这个`世界发生什么变化，为什么变化，怎么变化，抓住变化！`当然我承认世界是掌握于小数人，但能先抓住自己！这就是好的开始~
